...
icon = Image.open(r"C:\Users\mm\Desktop\project 2\phonepe.png")
st.set_page_config(page_title= "Phonepe Pulse Data Exploration & Visualization | By Faizal",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *Faizal*!
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv(r'C:\Users\mm\Desktop\project 2\indian_states.csv')
            df1.State = df2
...
# EXPLORE DATA - USERS      
    if Type == "Users":
        ...
        df2 = pd.read_csv(r'C:\Users\mm\Desktop\project 2\statesname.csv')
